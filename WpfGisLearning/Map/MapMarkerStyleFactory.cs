...
public static class MapMarkerStyleFactory
{
    ...
    private const string ClusterColor = "#343A40";
    ...
    private const double ClusterScale = 1.6;
    ...
    public static SymbolStyle CreateClusterMarker()
    {
        return new SymbolStyle
        {
            SymbolType = SymbolType.Ellipse,
            SymbolScale = ClusterScale,
            Fill = new Brush(Color.FromString(ClusterColor)),
            Outline = new Pen
            {
                Color = Color.White,
                Width = 2
