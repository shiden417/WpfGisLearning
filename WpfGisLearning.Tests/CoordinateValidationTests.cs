...
public class CoordinateValidationTests
{
    ...
    [DataRow(-90.0, -180.0)]
    [DataRow(90.0, 180.0)]
    public void IsValid_ValidCoordinates_ReturnsTrue(double latitude, double longitude)
    {
    ...
    [DataRow(35.0, 180.1)]
    [DataRow(0.0, 0.0)]
    public void IsValid_InvalidCoordinates_ReturnsFalse(double latitude, double longitude)
    {
        Assert.IsFalse(MapCoordinateValidator.IsValid(latitude, longitude));
    }

    [TestMethod]
    public void IsValid_NaN_ReturnsFalse()
    {
    ...
    [TestMethod]
    public void IsValid_Infinity_ReturnsFalse()
    {
